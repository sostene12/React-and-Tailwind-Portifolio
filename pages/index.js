...
export default function Home() {
  return (
    <>
      <Head>
        <title>Dimitri Marco portifolio</title>
      ...
      <main className='bg-white px-10'>
        <section className='min-h-screen'>
          ...
          <div className='text-center p-10'>
            <h2 className='text-3xl p-2 text-teal-500 font-medium'>Dimitri Marco</h2>
        ...
        <section>
          ...
          <div>
            <div className='text-center shadow-lg p-10 rounded-xl my-10'>
              ...
              <h3 className='text-lg font-medium pt-8 ppb-2'>Beautiful Designs</h3>
              <p className='py-2'>
